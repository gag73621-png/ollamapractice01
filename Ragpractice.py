...
def _format_resources(context_docs: List[Any])->List[str]:
    return [ 
        str((
...
st.set_page_config(page_title="To check the tcs policies", layout="wide", page_icon="🏛️")
st.title("TCS Policies Checker")
